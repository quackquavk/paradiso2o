...
const About = () => {
  ...
  useEffect(() => {
    ...
    gsap.to(musicIcon, {
      ...
      ease: "none",
      repeat: 0,
      transformOrigin: "50% 50%", // Center of the music icon
    });

    // ScrollTrigger for animation trigger
  ...
  return (
    <section
      ...
      id="about"
    >
      <div className="flex flex-col mt-10 max-w-full md:max-w-7xl md:flex-row md:gap-[10vw] px-3 md:px-0 gap-[5] w-full justify-between">
        <Image
          ref={imageRef1}
        ...
        <div ref={textRef1} className="">
          ...
          <p className="mt-4 text-white text-[20px]  text-justify">
            ...
            Paradiso an unforgettable dining experience.
          </p>
        </div>
      </div>
